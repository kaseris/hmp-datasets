...
import os
from hmpdata.human36m._pgbig import forward_kinematics
...
def expmap2rotmat_torch(opt, r):
    ...
    n = r1.data.shape[0]
    R = (
        torch.eye(3, 3).repeat(n, 1, 1).float().to(opt.cuda_idx)
